...
const CALC_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { difficulty: "hard", q: "Use the Born-Haber cycle for CaCl₂ below to find the lattice enthalpy.", hint: "Ca loses 2 electrons. 2 x EA₁ for 2 Cl atoms. ΔHat for full Cl₂.", answer: -2253, unit: "kJ mol⁻¹", tolerance: 5, diagram: React.createElement("img", {src:"/bh-cacl2.png", alt:"CaCl₂ Born-Haber cycle", style:{width:"100%",borderRadius:"8px"}}), steps: ["-795 = 178 + 242 + 590 + 1145 + 2(-349) + ΔHlatt", "-795 = 178 + 242 + 590 + 1145 - 698 + ΔHlatt", "-795 = +1457 + ΔHlatt", "ΔHlatt = -795 - 1457 = -2252 kJ mol⁻¹"] },
      ...
      // ═══ EXAM (10) ═══
      { difficulty: "exam", q: "Use the Born-Haber cycle for MgCl₂ below to calculate the lattice enthalpy.", hint: "Mg²⁺ needs IE₁ + IE₂. Full Cl₂ atomisation. 2 x EA₁.", dataTable: [["ΔHf(MgCl₂)","-641"],["ΔHat(Mg)","+148"],["ΔHat(Cl₂)","+242"],["IE₁(Mg)","+738"],["IE₂(Mg)","+1451"],["EA₁(Cl)","-349"]], answer: -2523, unit: "kJ mol⁻¹", tolerance: 5, diagram: React.createElement("img", {src:"/bh-mgcl2.png", alt:"MgCl₂ Born-Haber cycle", style:{width:"100%",borderRadius:"8px"}}), steps: ["-641 = 148 + 242 + 738 + 1451 + 2(-349) + ΔHlatt", "-641 = 148 + 242 + 738 + 1451 - 698 + ΔHlatt", "-641 = 1881 + ΔHlatt", "ΔHlatt = -641 - 1881 = -2522 kJ mol⁻¹"] },
                ...
                <div style={{ background: "#ffffff", borderRadius: "16px", padding: "24px", boxShadow: "0 2px 12px rgba(0,0,0,0.07)", marginBottom: "14px", border: "1px solid #e8eef4" }}>
                  ...
                  {(q.dataTable || q.diagram) && (
                    <div style={{ display: "flex", gap: "24px", alignItems: "flex-start", margin: "16px 0", flexWrap: "wrap" }}>
                      ...
                      {q.diagram && (
                        <div style={{ flex: 1, minWidth: "260px", maxWidth: "800px" }}>{q.diagram}</div>
                      )}
                    </div>
                  )}
