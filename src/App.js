...
const CALC_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { difficulty: "easy", q: "All ions in a TOF mass spectrometer are given the same kinetic energy.\nIon A has mass 2m and Ion B has mass m.\nWhich ion reaches the detector first?", hint: "KE = 1/2 mv². If KE is the same, lighter ions have higher velocity.", answer: "B", unit: "", tolerance: 0, isText: true, steps: ["KE = 1/2 mv²", "If m is smaller, v must be larger (for same KE)", "Ion B (lighter) travels faster", "Ion B reaches the detector first"] },
      ...
      { difficulty: "easy", q: "State the two stages that occur before ions enter the drift region in a TOF mass spectrometer.", hint: "Think about what happens to the sample first.", answer: "IONISATIONACCELERATION", unit: "", tolerance: 0, isText: true, steps: ["1. Ionisation (sample is ionised to form positive ions)", "2. Acceleration (ions are accelerated by an electric field)", "All ions gain the same kinetic energy"] },
      { difficulty: "easy", q: "Why must a TOF mass spectrometer operate under a vacuum?", hint: "What would happen if gas molecules were present?", answer: "COLLISION", unit: "", tolerance: 0, isText: true, steps: ["Gas molecules would collide with the ions", "This would slow them down or deflect them", "Giving inaccurate m/z values and times of flight", "Answer: to prevent collisions with gas molecules"] },
      { difficulty: "easy", q: "In electrospray ionisation, what ion is formed from molecule M?", hint: "A proton is added.", answer: "MH+", unit: "", tolerance: 0, isText: true, steps: ["In electrospray ionisation:", "The molecule gains a proton (H⁺)", "Forming MH⁺ (not M⁺)", "So the m/z peak appears at Mr + 1"] },
      ...
      { difficulty: "medium", q: "Explain why heavier ions arrive at the detector later than lighter ions in a TOF mass spectrometer.", hint: "Think about KE = 1/2 mv² and what happens when m increases.", answer: "VELOCITY", unit: "", tolerance: 0, isText: true, steps: ["All ions are given the same kinetic energy", "KE = 1/2 mv²", "For the same KE, if mass m increases, velocity v must decrease", "Slower ions take longer to travel through the drift region", "So heavier ions have a longer time of flight"] },
      ...
      { difficulty: "exam", q: "Explain how a TOF mass spectrometer separates isotopes of the same element.\nYour answer should refer to ionisation, acceleration, drift, and detection.", hint: "Describe each stage and explain why isotopes are separated.", answer: "SAMEKE", unit: "", tolerance: 0, isText: true, steps: ["1. Ionisation: atoms are ionised (electron impact or electrospray) to form positive ions", "2. Acceleration: all ions are accelerated by the same electric field, giving them all the SAME kinetic energy", "3. Drift: ions enter a field-free drift region. Since KE = 1/2 mv², lighter isotopes travel faster than heavier ones", "4. Detection: lighter ions arrive first. The detector records time of flight, which is used to calculate m/z", "Isotopes are separated because they have different masses but the same kinetic energy"] },
    ]
  },
  {
