...
const MECHS = [
  {
    ...
    arrowPaths: {
      a1: { d:"M 270,240 C 224,226 208,192 234,156", label:"OH⁻ lone pair → δ+C (new C-O bond forms)", type:"full" },
      a2: { d:"M 280,126 C 290,100 310,98 326,120", label:"C-Br breaks → Br⁻ leaves", type:"full" },
    },
  },
  {
    id: "nuc_sub_cn",
    ...
    arrowPaths: {
      a1: { d:"M 270,240 C 224,226 208,192 234,156", label:"CN⁻ lone pair → δ+C (new C-C bond forms)", type:"full" },
      a2: { d:"M 280,126 C 290,100 310,98 326,120", label:"C-Br breaks → Br⁻ leaves", type:"full" },
    },
  },
  {
...
function MechSVG({ mech, stepIdx, animKey, stillMode=false, visibleArrowCount=999 }) {
  ...
  if (mech.id === "nuc_sub") {
    ...
    if (showProducts) {
      return (
        <MechSVGBase animKey={animKey}>
          <image href={imgSrc} x={-580} y={-30} width={1000} height={559} />
          {renderArrows()}
        </MechSVGBase>
      );
    }
    return (
      <MechSVGBase animKey={animKey}>
        ...
        <image href={imgSrc} x={10} y={-30} width={1000} height={559} clipPath="url(#nuc-sub-reactant)"/>
        {renderArrows()}
      </MechSVGBase>
    );
  }
  ...
  if (mech.id === "nuc_sub_cn") {
    ...
    return (
      <MechSVGBase animKey={animKey}>
        <defs><clipPath id="nuc-sub-cn-reactant"><rect x="0" y="0" width="440" height="280"/></clipPath></defs>
        <image href={imgSrc} x={10} y={-30} width={1000} height={559} clipPath="url(#nuc-sub-cn-reactant)"/>
        {renderArrows()}
      </MechSVGBase>
    );
  }
  ...
  if (mech.id === "ea_br2") {
    ...
    return (
      <MechSVGBase animKey={animKey}>
        ...
        {/* Br₂ */}
        <A x={370} y={140} el="Br" size={18}/>
        <Delta x={358} y={118} sign="+"/>
        <Bond x1={388} y1={140} x2={425} y2={140}/>
        <A x={440} y={140} el="Br" size={18}/>
    ...
    if (stepN === 2) {
      ...
      return (
        <MechSVGBase animKey={animKey}>
          ...
          <Charge x={496} y={124} val="-"/>
          <LP x={470} y={140} angle={180}/>
  ...
  if (mech.id === "nuc_add") {
    ...
    if (stepN === 2 || stepN === 3) {
      return (
        <MechSVGBase animKey={animKey}>
          ...
          <Charge x={174} y={68} val="-"/>
          <LP x={155} y={84} angle={180}/>
          {/* CN down-right */}
          <Bond x1={164} y1={150} x2={194} y2={178}/>
          <A x={205} y={188} el="C" size={16}/>
    ...
    return (
      <MechSVGBase animKey={animKey}>
        ...
        <A x={108} y={140} el="C" size={18}/>
        <Charge x={128} y={122} val="-"/>
        <LP x={108} y={140} angle={0}/>
    ...
    if (stepN === 2) {
      return (
        <MechSVGBase animKey={animKey}>
          ...
          <A x={190} y={82} el="NH₂" size={16}/>
          {/* O⁻ right-up */}
          <Bond x1={200} y1={132} x2={245} y2={104}/>
          <A x={258} y={96} el="O" size={18}/>
          <Charge x={278} y={80} val="-"/>
          <LP x={258} y={96} angle={0}/>
          {/* Cl down-right */}
    ...
    if (stepN === 1) {
      return (
        <MechSVGBase animKey={animKey}>
          ...
          <A x={195} y={76} el="H" size={16}/>
          <Bond x1={195} y1={84} x2={195} y2={90}/>
          <A x={420} y={145} el="NO₂" size={18}/>
          <Charge x={452} y={128} val="+"/>
  ...
  if (mech.id === "elimination") {
    return (
      <MechSVGBase animKey={animKey}>
        {/* OH⁻ base */}
        <A x={60} y={140} el="HO" size={18}/>
        <Charge x={86} y={122} val="-"/>
        <LP x={80} y={140} angle={0}/>
