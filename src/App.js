...
const CALC_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { difficulty: "easy", q: "Calculate the mass (kg) of one atom of ²⁰Ne.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000)", answer: 3.322e-26, unit: "kg", tolerance: 1e-28, steps: ["mass (kg) = Mr / (L x 1000)", "mass = 20 / (6.022 x 10²³ x 1000)", "mass = 3.322 x 10⁻²⁶ kg"] },
      { difficulty: "easy", q: "Calculate the mass (kg) of one ³⁵Cl⁺ ion.\n(L = 6.022 x 10²³ mol⁻¹, ignore electron mass)", hint: "mass (kg) = Mr / (L x 1000)", answer: 5.814e-26, unit: "kg", tolerance: 1e-28, steps: ["mass (kg) = Mr / (L x 1000)", "mass = 35 / (6.022 x 10²³ x 1000)", "mass = 5.814 x 10⁻²⁶ kg", "(electron mass is negligible)"] },
      { difficulty: "easy", q: "Calculate the mass (kg) of one ¹⁶O atom.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000)", answer: 2.658e-26, unit: "kg", tolerance: 1e-28, steps: ["mass (kg) = Mr / (L x 1000)", "mass = 16 / (6.022 x 10²³ x 1000)", "mass = 2.658 x 10⁻²⁶ kg"] },
      ...
      { difficulty: "easy", q: "An ⁴⁰Ar⁺ ion has KE = 3.20 x 10⁻¹⁶ J.\nCalculate its velocity.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then v = sqrt(2KE/m)", answer: 98180, unit: "m s⁻¹", tolerance: 500, steps: ["mass = 40 / (6.022 x 10²³ x 1000) = 6.644 x 10⁻²⁶ kg", "v = sqrt(2 x 3.20 x 10⁻¹⁶ / 6.644 x 10⁻²⁶)", "v = sqrt(9.632 x 10⁹)", "v = 9.81 x 10⁴ m s⁻¹"] },
      { difficulty: "easy", q: "A ¹²C⁺ ion has velocity 2.00 x 10⁵ m s⁻¹.\nCalculate its kinetic energy.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then KE = 1/2 mv²", answer: 3.99e-16, unit: "J", tolerance: 1e-17, steps: ["mass = 12 / (6.022 x 10²³ x 1000) = 1.993 x 10⁻²⁶ kg", "KE = 1/2 x 1.993 x 10⁻²⁶ x (2.00 x 10⁵)²", "KE = 0.5 x 1.993 x 10⁻²⁶ x 4.00 x 10¹⁰", "KE = 3.99 x 10⁻¹⁶ J"] },
      { difficulty: "easy", q: "An ion has mass 1.063 x 10⁻²⁵ kg. Convert this to an m/z value (for z = 1).\n(L = 6.022 x 10²³ mol⁻¹)", hint: "m/z = mass (kg) x L x 1000", answer: 64, unit: "", tolerance: 0.5, steps: ["m/z = mass (kg) x L x 1000", "m/z = 1.063 x 10⁻²⁵ x 6.022 x 10²³ x 1000", "m/z = 64.0 (likely ⁶⁴Zn⁺ or ⁶⁴Cu⁺)"] },

      // ═══ MEDIUM (12) ═══
      { difficulty: "medium", q: "A ²³Na⁺ ion is accelerated to a KE of 4.80 x 10⁻¹⁶ J. The drift region is 1.20 m.\nCalculate the time of flight.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then v = sqrt(2KE/m), then t = d/v", answer: 7.57e-6, unit: "s", tolerance: 1e-7, steps: ["mass = 23 / (6.022 x 10²³ x 1000) = 3.820 x 10⁻²⁶ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 3.820 x 10⁻²⁶)", "v = sqrt(2.513 x 10¹⁰) = 1.585 x 10⁵ m s⁻¹", "t = 1.20 / (1.585 x 10⁵) = 7.57 x 10⁻⁶ s"] },
      { difficulty: "medium", q: "A ⁵⁶Fe⁺ ion has KE = 3.20 x 10⁻¹⁶ J. The drift region is 1.50 m.\nCalculate the time of flight.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then v = sqrt(2KE/m), then t = d/v", answer: 1.81e-5, unit: "s", tolerance: 2e-7, steps: ["mass = 56 / (6.022 x 10²³ x 1000) = 9.299 x 10⁻²⁶ kg", "v² = 2(3.20 x 10⁻¹⁶) / (9.299 x 10⁻²⁶) = 6.883 x 10⁹", "v = sqrt(6.883 x 10⁹) = 8.296 x 10⁴ m s⁻¹", "t = 1.50 / 8.296 x 10⁴ = 1.81 x 10⁻⁵ s"] },
      { difficulty: "medium", q: "Two isotopes ³⁵Cl⁺ and ³⁷Cl⁺ are accelerated with KE = 4.80 x 10⁻¹⁶ J. Drift region = 1.50 m.\nCalculate the difference in their times of flight.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000). Calculate t for each isotope separately, then subtract.", answer: 3.29e-7, unit: "s", tolerance: 1e-8, steps: ["m(³⁵Cl) = 35 / (6.022 x 10²³ x 1000) = 5.812 x 10⁻²⁶ kg", "v(³⁵Cl) = sqrt(2 x 4.80 x 10⁻¹⁶ / 5.812 x 10⁻²⁶) = 1.285 x 10⁵", "t(³⁵Cl) = 1.50 / 1.285 x 10⁵ = 1.167 x 10⁻⁵ s", "m(³⁷Cl) = 37 / (6.022 x 10²³ x 1000) = 6.146 x 10⁻²⁶ kg", "v(³⁷Cl) = sqrt(2 x 4.80 x 10⁻¹⁶ / 6.146 x 10⁻²⁶) = 1.249 x 10⁵", "t(³⁷Cl) = 1.50 / 1.249 x 10⁵ = 1.200 x 10⁻⁵ s", "Difference = 1.200 x 10⁻⁵ - 1.167 x 10⁻⁵ = 3.29 x 10⁻⁷ s"] },
      ...
      { difficulty: "medium", q: "An ion has mass 6.56 x 10⁻²⁶ kg. Convert this to a relative mass (m/z for z=1).\n(L = 6.022 x 10²³ mol⁻¹)", hint: "m/z = mass (kg) x L x 1000", answer: 39.5, unit: "", tolerance: 0.5, steps: ["m/z = mass (kg) x L x 1000", "m/z = 6.56 x 10⁻²⁶ x 6.022 x 10²³ x 1000", "m/z = 39.5 (likely ⁴⁰Ar or ⁴⁰Ca)"] },
      ...
      { difficulty: "medium", q: "A ¹⁴N⁺ ion is accelerated to KE = 4.80 x 10⁻¹⁶ J. Drift region = 1.50 m.\nCalculate the time of flight.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then v = sqrt(2KE/m), then t = d/v", answer: 7.38e-6, unit: "s", tolerance: 1e-7, steps: ["mass = 14 / (6.022 x 10²³ x 1000) = 2.325 x 10⁻²⁶ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 2.325 x 10⁻²⁶)", "v = sqrt(4.129 x 10¹⁰) = 2.032 x 10⁵ m s⁻¹", "t = 1.50 / 2.032 x 10⁵ = 7.38 x 10⁻⁶ s"] },
      { difficulty: "medium", q: "A ¹²C⁺ ion is accelerated with KE = 4.80 x 10⁻¹⁶ J.\nCalculate its velocity.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then v = sqrt(2KE/m)", answer: 219462, unit: "m s⁻¹", tolerance: 2000, steps: ["mass = 12 / (6.022 x 10²³ x 1000) = 1.993 x 10⁻²⁶ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 1.993 x 10⁻²⁶)", "v = sqrt(4.817 x 10¹⁰)", "v = 2.195 x 10⁵ m s⁻¹"] },
      { difficulty: "medium", q: "A singly charged ion with m/z = 28 has KE = 3.20 x 10⁻¹⁶ J.\nCalculate its velocity.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), then v = sqrt(2KE/m)", answer: 117200, unit: "m s⁻¹", tolerance: 1000, steps: ["mass = 28 / (6.022 x 10²³ x 1000) = 4.650 x 10⁻²⁶ kg", "v = sqrt(2 x 3.20 x 10⁻¹⁶ / 4.650 x 10⁻²⁶)", "v = sqrt(1.376 x 10¹⁰)", "v = 1.173 x 10⁵ m s⁻¹"] },
      { difficulty: "medium", q: "An ion takes 1.50 x 10⁻⁵ s to travel 1.80 m. Its KE is 5.00 x 10⁻¹⁶ J.\nCalculate the m/z value of the ion.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "Find v = d/t, find m from KE = 1/2 mv², then m/z = mass (kg) x L x 1000.", answer: 42, unit: "", tolerance: 1, steps: ["v = 1.80 / 1.50 x 10⁻⁵ = 1.200 x 10⁵ m s⁻¹", "m = 2KE/v² = 2(5.00 x 10⁻¹⁶) / (1.200 x 10⁵)²", "m = 1.00 x 10⁻¹⁵ / 1.44 x 10¹⁰ = 6.944 x 10⁻²⁶ kg", "m/z = 6.944 x 10⁻²⁶ x 6.022 x 10²³ x 1000 = 41.8 ≈ 42"] },

      // ═══ HARD (8) ═══
      { difficulty: "hard", q: "Derive the equation: m = 2KE x t² / d²\nStarting from KE = 1/2 mv² and v = d/t.\nThen use it: KE = 4.80 x 10⁻¹⁶ J, t = 1.23 x 10⁻⁵ s, d = 1.50 m.\nCalculate m/z.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "Substitute v = d/t into KE = 1/2 mv², rearrange for m. Then m/z = mass (kg) x L x 1000.", answer: 39, unit: "", tolerance: 1, steps: ["v = d/t, so KE = 1/2 m(d/t)² = md²/(2t²)", "Rearranging: m = 2KE x t² / d²", "m = 2(4.80 x 10⁻¹⁶)(1.23 x 10⁻⁵)² / (1.50)²", "m = 2(4.80 x 10⁻¹⁶)(1.513 x 10⁻¹⁰) / 2.25", "m = 1.452 x 10⁻²⁵ / 2.25 = 6.45 x 10⁻²⁶ kg", "m/z = 6.45 x 10⁻²⁶ x 6.022 x 10²³ x 1000 = 38.8 ≈ 39 (K⁺)"] },
      { difficulty: "hard", q: "A ⁶³Cu⁺ ion and a ⁶⁵Cu⁺ ion are both accelerated with KE = 4.80 x 10⁻¹⁶ J. Drift region = 2.00 m.\nCalculate the time of flight for each and the time difference.\n(L = 6.022 x 10²³ mol⁻¹)\nGive the time difference in s.", hint: "mass (kg) = Mr / (L x 1000). Calculate t for each isotope separately.", answer: 3.29e-7, unit: "s", tolerance: 1e-8, steps: ["m(⁶³Cu) = 63 / (6.022 x 10²³ x 1000) = 1.046 x 10⁻²⁵ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 1.046 x 10⁻²⁵) = 9.578 x 10⁴", "t(⁶³Cu) = 2.00 / 9.578 x 10⁴ = 2.088 x 10⁻⁵ s", "m(⁶⁵Cu) = 65 / (6.022 x 10²³ x 1000) = 1.080 x 10⁻²⁵ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 1.080 x 10⁻²⁵) = 9.428 x 10⁴", "t(⁶⁵Cu) = 2.00 / 9.428 x 10⁴ = 2.121 x 10⁻⁵ s", "Difference = 2.121 x 10⁻⁵ - 2.088 x 10⁻⁵ = 3.29 x 10⁻⁷ s"] },
      { difficulty: "hard", q: "An unknown singly charged ion reaches the detector in 1.36 x 10⁻⁵ s.\nKE = 4.80 x 10⁻¹⁶ J, drift region = 1.50 m.\nCalculate m/z and identify the element.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "Find v = d/t, then m = 2KE/v², then m/z = mass (kg) x L x 1000.", answer: 48, unit: "", tolerance: 1, steps: ["v = d/t = 1.50 / (1.36 x 10⁻⁵) = 1.103 x 10⁵ m s⁻¹", "m = 2KE/v² = 2(4.80 x 10⁻¹⁶) / (1.103 x 10⁵)²", "m = 9.60 x 10⁻¹⁶ / 1.217 x 10¹⁰ = 7.89 x 10⁻²⁶ kg", "m/z = 7.89 x 10⁻²⁶ x 6.022 x 10²³ x 1000 = 47.5 ≈ 48 (Ti)"] },
      ...
      { difficulty: "exam", q: "In a TOF experiment, ion X⁺ has t = 1.243 x 10⁻⁵ s and ion Y⁺ has t = 1.085 x 10⁻⁵ s.\nBoth have KE = 4.80 x 10⁻¹⁶ J, drift = 1.50 m.\nCalculate m/z for both ions and identify them.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "For each: v = d/t, m = 2KE/v², m/z = mass (kg) x L x 1000.", answer: 40, unit: "", tolerance: 1, steps: ["Ion X: v = 1.50/1.243 x 10⁻⁵ = 1.207 x 10⁵ m s⁻¹", "m = 2(4.80 x 10⁻¹⁶)/(1.207 x 10⁵)² = 6.59 x 10⁻²⁶ kg", "m/z = 6.59 x 10⁻²⁶ x 6.022 x 10²³ x 1000 = 39.7 ≈ 40 (⁴⁰Ca⁺ or ⁴⁰Ar⁺)", "Ion Y: v = 1.50/1.085 x 10⁻⁵ = 1.383 x 10⁵ m s⁻¹", "m = 2(4.80 x 10⁻¹⁶)/(1.383 x 10⁵)² = 5.02 x 10⁻²⁶ kg", "m/z = 5.02 x 10⁻²⁶ x 6.022 x 10²³ x 1000 = 30.2 ≈ 30 (answer: X = m/z 40)"] },
      ...
      { difficulty: "exam", q: "A TOF mass spectrometer has drift region 1.80 m. An ion with m/z = 88 is detected at t = 2.15 x 10⁻⁵ s.\nCalculate the KE given to all ions in this spectrometer.\n(L = 6.022 x 10²³ mol⁻¹)", hint: "mass (kg) = Mr / (L x 1000), find v = d/t, then KE = 1/2 mv².", answer: 5.13e-16, unit: "J", tolerance: 1e-17, steps: ["m = 88 / (6.022 x 10²³ x 1000) = 1.462 x 10⁻²⁵ kg", "v = d/t = 1.80 / (2.15 x 10⁻⁵) = 8.372 x 10⁴ m s⁻¹", "KE = 1/2 mv² = 0.5 x 1.462 x 10⁻²⁵ x (8.372 x 10⁴)²", "KE = 0.5 x 1.462 x 10⁻²⁵ x 7.009 x 10⁹", "KE = 5.12 x 10⁻¹⁶ J"] },
      { difficulty: "exam", q: "Bromine has two isotopes: ⁷⁹Br (50.7%) and ⁸¹Br (49.3%).\nBoth are accelerated with KE = 4.80 x 10⁻¹⁶ J. Drift = 1.50 m.\nCalculate the Ar of bromine and the time of flight for each isotope.\n(L = 6.022 x 10²³ mol⁻¹)\nGive Ar to 1 d.p.", hint: "Ar from abundances first. Then mass (kg) = Mr / (L x 1000), v = sqrt(2KE/m), t = d/v.", answer: 80.0, unit: "", tolerance: 0.1, steps: ["Ar = (79 x 50.7 + 81 x 49.3) / 100 = 79.99 ≈ 80.0", "m(⁷⁹Br) = 79 / (6.022 x 10²³ x 1000) = 1.312 x 10⁻²⁵ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 1.312 x 10⁻²⁵) = 8.555 x 10⁴ m s⁻¹", "t(⁷⁹Br) = 1.50 / 8.555 x 10⁴ = 1.753 x 10⁻⁵ s", "m(⁸¹Br) = 81 / (6.022 x 10²³ x 1000) = 1.345 x 10⁻²⁵ kg", "v = sqrt(2 x 4.80 x 10⁻¹⁶ / 1.345 x 10⁻²⁵) = 8.446 x 10⁴ m s⁻¹", "t(⁸¹Br) = 1.50 / 8.446 x 10⁴ = 1.776 x 10⁻⁵ s"] },
    ]
  },
  {
