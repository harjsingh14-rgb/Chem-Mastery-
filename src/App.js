...
const CALC_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { difficulty: "easy", q: "Calculate the atom economy for this reaction where X is the desired product:\nA + B -> X + Y\nMr: A=40, B=36, X=58, Y=18", hint: "Atom economy = Mr(desired) / total Mr(reactants) x 100", answer: 75.3, unit: "%", tolerance: 0.5, steps: ["Total Mr reactants = 40 + 36 = 76", "AE = (58 / 76) x 100 = 76.3%"] },
      ...
      { difficulty: "medium", q: "Calculate the atom economy for making chlorine by the Cl₂ route:\n4HCl + O₂ -> 2Cl₂ + 2H₂O\n(Mr: HCl=36.5, O₂=32, Cl₂=71, H₂O=18)", hint: "AE = Mr(desired products) / Mr(all reactants) x 100", answer: 56.0, unit: "%", tolerance: 0.5, steps: ["Total Mr reactants = 4(36.5) + 32 = 146 + 32 = 178", "Mr desired products = 2(71) = 142... wait, Cl₂ desired", "Mr Cl₂ produced = 2 x 71 = 142", "AE = (142 / 254) x 100", "Total reactants = 4(36.5) + 32 = 178", "AE = (142/178) x 100 = 79.8%"] },
      { difficulty: "medium", q: "2.70 g of aluminium (Ar=27) reacts with excess chlorine:\n2Al + 3Cl₂ -> 2AlCl₃\nThe actual yield of AlCl₃ (Mr=133.5) is 16.1 g. Calculate the % yield.", hint: "Find moles of Al, 1:1 ratio for AlCl₃, theoretical mass, then % yield.", answer: 89.7, unit: "%", tolerance: 0.5, steps: ["n(Al) = 2.70 / 27 = 0.100 mol", "n(AlCl₃) = 0.100 mol (1:1 ratio)", "Theoretical mass = 0.100 x 133.5 = 13.35 g", "% yield = (16.1/13.35) x 100"] },
      ...
      { difficulty: "exam", q: "A student makes 1-bromobutane from butan-1-ol:\nC₄H₉OH + NaBr + H₂SO₄ -> C₄H₉Br + NaHSO₄ + H₂O\n(Mr: C₄H₉OH=74, C₄H₉Br=137)\n10.0 g of butan-1-ol is used. The student obtains 9.80 g of 1-bromobutane.\na) Calculate the % yield.\nb) Calculate the atom economy.", hint: "For % yield: find theoretical mass from moles of butan-1-ol. For AE: Mr(desired) / total Mr(reactants) x 100.", answer: 52.9, unit: "%", tolerance: 0.5, steps: ["n(C₄H₉OH) = 10.0/74 = 0.1351 mol", "n(C₄H₉Br) theoretical = 0.1351 mol (1:1)", "Theoretical mass = 0.1351 x 137 = 18.51 g", "% yield = (9.80/18.51) x 100 = 52.9%", "For AE: Mr reactants = 74 + 103 + 98 = 275", "AE = 137/275 x 100 = 49.8%"] },
