...
const CALC_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { difficulty: "hard", q: "Use the Born-Haber cycle for KCl to find the lattice enthalpy:\nΔHf(KCl) = -437\nΔHat(K) = +89\nΔHat(1/2 Cl₂) = +122\nIE₁(K) = +419\nEA₁(Cl) = -349 kJ mol⁻¹", hint: "ΔHf = ΔHat(K) + ΔHat(Cl) + IE₁ + EA₁ + ΔHlatt", answer: -718, unit: "kJ mol⁻¹", tolerance: 3, diagram: React.createElement("img", {src:"/bh-kcl.png", alt:"KCl Born-Haber cycle", style:{width:"100%",maxWidth:"500px",borderRadius:"8px"}}), steps: ["ΔHf = ΔHat(K) + ΔHat(Cl) + IE₁ + EA₁ + ΔHlatt", "-437 = 89 + 122 + 419 + (-349) + ΔHlatt", "-437 = +281 + ΔHlatt", "ΔHlatt = -437 - 281 = -718 kJ mol⁻¹"] },
      { difficulty: "hard", q: "Use the Born-Haber cycle for NaCl to find the lattice enthalpy:\nΔHf(NaCl) = -411\nΔHat(Na) = +108\nΔHat(1/2 Cl₂) = +121\nIE₁(Na) = +496\nEA₁(Cl) = -349 kJ mol⁻¹", hint: "Sum all steps = ΔHf. Rearrange for ΔHlatt.", answer: -787, unit: "kJ mol⁻¹", tolerance: 3, diagram: React.createElement("img", {src:"/bh-nacl.png", alt:"NaCl Born-Haber cycle", style:{width:"100%",maxWidth:"500px",borderRadius:"8px"}}), steps: ["-411 = 108 + 121 + 496 + (-349) + ΔHlatt", "-411 = +376 + ΔHlatt", "ΔHlatt = -411 - 376 = -787 kJ mol⁻¹"] },
      { difficulty: "hard", q: "Use the Born-Haber cycle for LiF to find ΔHlatt:\nΔHf(LiF) = -617\nΔHat(Li) = +161\nΔHat(1/2 F₂) = +79\nIE₁(Li) = +520\nEA₁(F) = -328 kJ mol⁻¹", hint: "ΔHf = sum of all steps", answer: -1049, unit: "kJ mol⁻¹", tolerance: 3, diagram: React.createElement("img", {src:"/bh-lif.png", alt:"LiF Born-Haber cycle", style:{width:"100%",maxWidth:"500px",borderRadius:"8px"}}), steps: ["-617 = 161 + 79 + 520 + (-328) + ΔHlatt", "-617 = +432 + ΔHlatt", "ΔHlatt = -617 - 432 = -1049 kJ mol⁻¹"] },
