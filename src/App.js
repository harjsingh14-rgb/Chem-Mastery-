...
const CALC_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { difficulty: "exam", q: "For AgI, the experimental (Born-Haber) lattice enthalpy is -876 kJ mol⁻¹ but the theoretical (ionic model) value is -736 kJ mol⁻¹.\nCalculate the % discrepancy.", hint: "% discrepancy = |experimental - theoretical| / |experimental| x 100", answer: 16.0, unit: "%", tolerance: 0.5, steps: ["% = |(-876) - (-736)| / 876 x 100", "= 140 / 876 x 100 = 16.0%", "Large discrepancy suggests significant covalent character", "Ag⁺ is small and highly polarising; I⁻ is large and polarisable", "The bonding is not purely ionic — covalent character present (Fajans' rules)"] },
